...
<head>
    <meta charset="UTF-8">
    <title>Black Legion – Warhammer 40,000 Codex</title>
    <style>
        body {
...
<main class="main-content">
    <img src="BLK.jpg" alt="Black Legion Banner" class="side-img left">
    <div class="lore-box">
        <h2>The Black Legion</h2>
        <p>
...
In the aftermath of the greatest of the nascent Imperium's victories to date, the defeat of the largest Ork empire ever encountered, Horus was granted the title of "Warmaster," commander-in-chief of all the Emperor's armies. So great was the victory that his Legion, originally called the Luna Wolves, was later renamed the Sons of Horus.

The Emperor returned to Terra to oversee the next phase of the creation of His interstellar empire, but on the moon of the Feral World of Davin, Horus was struck down by a malady devised by the Nurglish Chaos artefact known as the Anathame that was sufficiently virulent to affect even a superhumanly resilient primarch.

At some point during his treatment or recovery, Horus was inducted into one of Davin's warrior lodges, the Temple of the Serpent Lodge, and it is likely that during that process, he was corrupted in some manner that led to his eventual downfall. Horus emerged from his illness changed, and the practise of establishing Warrior Lodges spread throughout the Legions. With it, apparently, spread whatever Chaos taint had corrupted the Warmaster, and the fate of the galaxy was sealed.
...
Whatever the case, events reached a head according to the Warmaster's strategy when he virus-bombed the remaining Loyalists in the nascent Traitor Legions on the world of Isstvan III, an act so dire that five entire Astartes Legions were despatched to call him to account for his apparent rejection of all the Great Crusade stood for.

It was at Isstvan V that the Warmaster finally revealed his true colours. The first wave of the Legions sent to confront Horus made planetfall, only to discover themselves in the midst of treachery. Faced with overwhelming odds, the Salamanders, Raven Guard and Iron Hands -- later known as the Shattered Legions -- attempted to link up with the second wave, only for the true extent of the Warmaster's treachery to be fully realised.
...
The Imperial Army was split almost in half, regiment fighting regiment and ﬂeet fighting ﬂeet. The Titan Legions of the Mechanicum, the ancestors of the Adeptus Mechanicus, were equally affected, and soon fully half of the Emperor's hosts were engaged in bitter conﬂict with the other. Barely a single world was untouched by a war that accounted for countless billions of lives and that culminated in the Warmaster's assault on Terra itself.
...
Even as Rogal Dorn carried the Emperor's body from the Warmaster's battle barge, the Traitor hosts began their fighting withdrawal, and in the anarchy and confusion Horus' body was recovered by his Legion. Having fought their way clear of the Sol System and ﬂed for the Eye of Terror, the Sons of Horus established themselves upon a world that was at once the tomb of their lost primarch and a fortress from which they would launch further attacks both upon their fellow Traitor Legions and against the smouldering Imperium.

Bereft of their glorious primarch, the Legion ﬂoundered, and in desperation turned to each of the Chaos Gods in turn in their search for renewed power, inviting daemonic possession and the ever more costly blessings of the Warp.
...
When the warbands of the Black Legion and their allies gather under the wrathful banner of the Chaos Lord and Warmaster of Chaos now called Abaddon the Despoiler, the words of Horus are ever heard upon their lips -- let the galaxy burn.
    ...
    <img src="eight.png" alt="Black Legion Art" class="side-img right center-img">
</main>
</body>
</html>
